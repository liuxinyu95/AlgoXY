...
经过上述改进后的模型开始运行后，经过漫长的时间也无法达到9成人口的感染。这说明主动隔离治疗真的非常有效，作者调整程序退出条件。
...
大约合28天后，才有2\%的人口染病。考虑人们仅仅在白天活动，实际时间约为84天，也就是3个月。这位研制出疫苗赢得了宝贵的时间。
用Excel描绘主动隔离治疗后的传染速度曲线如下：

\begin{figure}[htbp]
       \begin{center}
	\includegraphics[scale=0.5]{images/epidemic-hospital.eps}
        \caption{epidemic controled by hospital}
       \end{center}
\end{figure}
...
\begin{figure}[htbp]
	...
	\includegraphics[scale=0.5]{images/epidemic-deli.eps}
        \caption{epidemic with delitescense}
       \end{center}
\end{figure}
