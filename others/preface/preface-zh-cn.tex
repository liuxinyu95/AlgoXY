...
冈崎（Chris Okasaki）和伯德（Richard Bird）的优秀工作奠定了基本函数式算法和数据结构的主要内容。得益于此，本书可以说是对他们所建框架的剪裁与组织。尽管函数式编程的应用和前沿技术发展日新月异，基本算法部分却相对稳定。这使得我可以用十多年时间逐渐修改、完善，并把这本书\footnote{本书电子版可以在github上获得，如果希望获得纸质版，请在github上联系我。}呈现到读者面前。
