...
\begin{figure}[htbp]
  ...
  \caption{First 4 steps to generate regular numbers. (1). Initialize with 1; (2). Add 2, 3, and 5 back; (3). Add 4, 6, and 10 back; (4). Add 9 and 15 back, 6 is dropped.}
  \label{fig:queues}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{First 4 steps with $Q_2$, $Q_3$, and $Q_5$. \newline
(1) Initialize with 2, 3, 5; (2) Enqueue 4, 6, 10; (3) Enqueue 9, 15; (4) Enqueue 8, 12, 20; (5) Enqueue 25.}
  \label{fig:q235}
\end{figure}
