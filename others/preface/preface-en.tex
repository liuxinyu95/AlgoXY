...
Suppose IDs are positive integers and all IDs in use are kept
...
to define an integer range from $a$ to $b$ with $b$ excluded.
...
Some languages do provide handy tools which wrap this linear time
