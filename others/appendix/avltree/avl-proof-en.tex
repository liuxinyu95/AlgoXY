...
Given the 4 cases need fix as shown in figure \ref{fig:avl-insert-fix-appendix}, The balance factors are either -2, or +2. After adjustment, the factor resumes
