...
points back to previous one. Figure \cref{fig:circular-list} shows such situation.
...
start racing both at point $A$ as shown in figure \cref{fig:circular-catching}.
...
As illustrated in figure \cref{fig:circular-catching}, start from any node behind the
...
for a linked-list with circle, the reversed head is same. Figure \cref{fig:reverse} shows the result.
