...
The problem of circular list is a special one of general Cycle detection problem \cite{wiki-cycle-detection}.
...
as the `tortoise and the hare' algorithm. Richard P. Brend invented another algorithm illustratted in
