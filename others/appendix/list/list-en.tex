...
\begin{Exercise}
\begin{enumerate}
\item Implement the imperative takking and dropping algorithm in your favorite programming language, note that
the out of bound cases should be handled.
\end{enumerate}
\end{Exercise}

\section{splitting-at, breaking and grouping}
