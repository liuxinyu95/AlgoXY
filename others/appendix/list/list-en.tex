...
In fact ISO C++ provides the very same mapping concept as in \texttt{std::transform}. However,
...
For example Haskell Monad library provides both \texttt{mapM}, \texttt{mapM_} and \texttt{forM}, \texttt{forM_}.
