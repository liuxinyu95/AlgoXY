...
Search and filter are generic concept apply to a wide range of things. For list, it often takes linear time to find the result, as we need traverse.

matching are very important algorithms. They are not only limited to linked list, but also
