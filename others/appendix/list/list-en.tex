...
The definition of $unzip$ can be directly written as the inverse of $zip$. Here we give a realization based on
folding-right.

\be
unzip(L) = foldr(\lambda_{(a, b)} \cdot (cons(a, A), cons(b, B)), (\Phi, \Phi), L)
\ee
