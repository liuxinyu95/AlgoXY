...
Where $f \cdot g$ means function composing, that we first apply $g$ then apply $f$. Note that we use Curried form
to omit the argument $L$.

TODO: Add imperative mapping.
