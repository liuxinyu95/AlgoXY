...
proc(f, z, L) = \left \{
  ...
  {r@{\quad:\quad}l}
  z & L = \Phi \\
  f(l_1, proc(L')) & otherwise
  \end{array}
\right.
\]

That's it, and we should name this common structure a better name instread of the meaningless `proc'. Let's
...
in the following photoes. (Photographed by the author)

\begin{figure}[htbp]
    \centering
    \subfloat[]{\includegraphics[scale=0.3]{img/fold-fan1.eps}} \\
    \subfloat[]{\includegraphics[scale=0.3]{img/fold-fan2.eps}} 
    \subfloat[]{\includegraphics[scale=0.3]{img/fold-fan3.eps}}
