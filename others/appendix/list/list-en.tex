...
\subsection{splitting-at, breaking and grouping}
...
\begin{Exercise}
\begin{enumerate}
\item Implement the imperative taking and dropping algorithm in your favorite programming language, note that
the out of bound cases should be handled.
\item Implement take-while and drop-while in your favorite imperative programming language.
\end{enumerate}
\end{Exercise}
