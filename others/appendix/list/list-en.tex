...
However, these two grouping algorithms have quite different type of condition to determine at where the grouping
should happen. Let's try to solve the first string groupping problem first.
