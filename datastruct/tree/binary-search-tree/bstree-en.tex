...
get the left sub-tree, right sub-tree and the key of the node they are called on, respectively.
...
It can be found that the in-order walk of a BST outputs
the elements in increase order, which is particularly helpful. The definition
of BST ensures this interesting property, while the
