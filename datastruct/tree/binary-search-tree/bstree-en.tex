...
It is not by accident that the in-order traverse lists the elements one by one increasingly. The definition of the BST ensures it is always true. We leave the proof as an exercise.
