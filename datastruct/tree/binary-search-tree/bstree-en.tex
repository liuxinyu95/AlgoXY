...
When the list is empty, the result is an empty tree; otherwise, it inserts the first element to the tree, then recursively inserts the rests. By using list folding (see appendix A.6), we can also define the $fromList$ like the following:
