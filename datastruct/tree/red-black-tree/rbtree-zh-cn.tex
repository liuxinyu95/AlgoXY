...
但是，如果两个子节点中，有一个是双重黑色的空节点，另外一个也是空节点，就需要把双重黑色的属性推到上一层。如图\ref{fig:db-fix-2-nil}所示，如果删除节点1，我们用一个双重黑色空节点代替它。于是节点2就有了两个空子节点，其中一个是双重黑色的。这种情况下，我们需要把节点2染成双重黑色，它的两个字节点就可以变成普通的空节点了。
