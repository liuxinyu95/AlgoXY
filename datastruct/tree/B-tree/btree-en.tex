...
Hence a B-tree is balanced. The simplest B-tree is called 2-3-4 tree, where $t = 2$. Every node except for the root contains 2, 3, or 4 keys. Essentially, a red-black tree can be mapped to a 2-3-4 tree. Below example program defines the B-tree.
...
The empty node of degree $t$ is in the form of \texttt{Node [] [] t}.
