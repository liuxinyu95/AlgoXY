...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{2-3-4 tree}{\includegraphics[scale=0.5]{img/btree-insert-fp-234.ps}} \\
  \subcaptionbox{B-tree of $d = 3$}{\includegraphics[scale=0.5]{img/btree-insert-fp-3.ps}}
  \caption{Repeatedly insert elements from "GMPXACDEJKNORSTUVYZ".}
