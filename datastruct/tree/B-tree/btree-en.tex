...
$(\mathbb{K}, \mathbb{C}, t)$, where $\mathbb{K}$ are keys, $\mathbb{C}$
are children, and $t$ is the minimum degree.
...
ins(T, k) = \left \{
  \begin{array}
  {r@{\quad:\quad}l}
  (\{\mathbb{K}_1\} \cup \{k\} \cup \{\mathbb{K}_2\}, \Phi, t) & \mathbb{C} = \Phi, \forall k' \in \mathbb{K}_1, k'' \in \mathbb{K}_2 \Rightarrow k' \leq k \leq k'' \\
  \end{array}
\right.
\ee
