...
\subsubsection{Insert then split}
...
We can reuse the list $splitAt$ function defined in chapter 1 to realize it.
...
$ins$ need handle two cases: for leaf node, we can reuse the list ordered $insert$ function defined in chapter 1; otherwise, we need find the position to recursively insert to sub-tree.
