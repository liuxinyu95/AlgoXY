...
In this chapter, we will first introduce How to generate B-tree by insertion.
Two different methods will be explained. One method is discussed in \cite{CLRS},
the other is a kind of modify-fix approach which quite similar to the
algorithm Okasaki given in red-black tree\cite{okasaki-rbtree}. This method
is also discussed in \cite{wiki-b-tree}. After that, how to delete
