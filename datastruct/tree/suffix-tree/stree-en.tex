...
famous KMP(Knuth-Morris-Pratt algorithm is introduced in the chatper of search)
...
$k$ times in $S$, then there are total $k$ leaves under this node\cite{ukkonen-lec}.
