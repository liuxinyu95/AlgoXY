...
To create suffix trie or suffix tree for a given string, we can utilize the
insertion algorithmS explained in previous chatper
for trie and Patricia. But this method isn't efficient
enough in terms of speed and spaces. By using suffix link concpet, we can
on-line construct suffix trie fast. Because trie isn't space efficient,
Ukkonen found a method, which can on-line construct suffix tree in linear time.
In this chapter, we explain Ukkonen's algorithm, and show
