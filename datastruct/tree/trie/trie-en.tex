...
TODO: change to license free images
...
Figure \ref{fig:radix-tree} shows a radix tree\cite{CLRS} contains the bit
strings 1011, 10, 011, 100 and 0. When searching a key $k=b_0b_1...b_n$, we
...
information is represented by edges. The key node with key string
