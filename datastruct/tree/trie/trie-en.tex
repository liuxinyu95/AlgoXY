...
We can test even/odd with the remainder modular 2: $even(k) = (k \bmod 2 = 0)$m or use bit-wise operation, like \texttt{(k \& 0x1) == 0}. We can eliminate the recursion through loops to realize an iterative implementation:
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{Insert $14 = (1110)_2$, which matches $p = (1100)_2$. It is inserted to the right.}{\includegraphics[scale=0.6, page=6]{img/trie}}\\
