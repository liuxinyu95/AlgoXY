...
called as \emph{binary trie}. A binary
...
of binary tree. The left sub tree is encoded as 0 and the right sub tree
is encoded as 1. The node can be used to store some satellite data.

The following example Python code defines integer trie. It uses
field \texttt{value} to store satellite data.
