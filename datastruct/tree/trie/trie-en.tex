...
For illustration purpose only, we limit the character set to lower case
English letter, from 'a' to 'z'.

Below ANSI C code defines the alphabetic trie.
...
TODO: left the dynamic children problem as exercise
