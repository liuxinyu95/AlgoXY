...
data, and $C = \{(c_1, T_1), (c_2, T_2), ..., (c_m, T_m)\}$ is the
map of children, which map from character $c_i$ to
...
If the key is empty, the previous value $v$ is overwritten with the
new value $v'$. Otherwise, we need check the children and perform
