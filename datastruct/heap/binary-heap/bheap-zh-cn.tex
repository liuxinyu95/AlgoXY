...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{步骤1：4、14和7中的最大元素是14。将4和左侧子节点交换；}{\includegraphics[scale=0.5]{img/heapify-1.ps}} \hspace{0.01\textwidth}
    \subcaptionbox{步骤2：2、4和8中的最大元素是8。将4和右侧子节点交换；}{\includegraphics[scale=0.5]{img/heapify-2.ps}} \\
    \subcaptionbox{4为叶子节点。过程结束。}{\includegraphics[scale=0.5]{img/heapify-3.ps}}
...
\begin{figure}[htbp]
\centering
\subcaptionbox{一个无序数组。}{\includegraphics[scale=0.5]{img/build-heap-array.ps}} \\
\subcaptionbox{第一步：数组被映射为二叉树。第一个分支节点的值是16。}{\includegraphics[scale=0.35]{img/build-heap-1.ps}}
\subcaptionbox{第二步：16是当前子树中的最大元素，接下来检查元素2所在的节点。}{\includegraphics[scale=0.35]{img/build-heap-2.ps}} \\
\subcaptionbox{第三步：14是子树中的最大元素，交换2和14；接下来检查元素为3的节点。}{\includegraphics[scale=0.35]{img/build-heap-3.ps}} %\hspace{0.2cm}
\subcaptionbox{第四步：10是子树中的最大元素，交换10和3；接下来检查元素为1的节点。}{\includegraphics[scale=0.35]{img/build-heap-4.ps}} \\
\subcaptionbox{第五步：16是子树中的最大元素，先交换16和1，接下来交换1和7；此后检查元素为4的根节点。}{\includegraphics[scale=0.35]{img/build-heap-5.ps}}
\subcaptionbox{第六步：交换4和14，然后交换4和8；堆构造结束。}{\includegraphics[scale=0.35]{img/build-heap-6.ps}}
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{第一步：第9个节点的值为4。}{\includegraphics[scale=0.35]{img/decrease-key-a.ps}}
    \subcaptionbox{第二步：将4增加到15，大于其父节点的值。}{\includegraphics[scale=0.35]{img/decrease-key-b.ps}} \\
    \subcaptionbox{第三步：根据最大堆的性质，交换8和15。}{\includegraphics[scale=0.35]{img/decrease-key-c.ps}}
    \subcaptionbox{第四步：因为15大于父节点的值14，它们进行交换。此后因为15小于16，处理过程结束。}{\includegraphics[scale=0.35]{img/decrease-key-d.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{$X$和$P$都是左子树或者$X$和$P$都是右子树。}{\includegraphics[scale=0.4]{img/zig-zig-a.ps}}
  \subcaptionbox{$X$经过两次旋转后成为了根节点。}{\includegraphics[scale=0.4]{img/zig-zig-b.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{$X$和$P$一棵是左子树另一棵是右子树。}{\includegraphics[scale=0.4]{img/zig-zag-a.ps}}
  \subcaptionbox{$X$成为根节点，$P$和$G$变成了兄弟节点。}{\includegraphics[scale=0.4]{img/zig-zag-b.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{$P$是根节点。}{\includegraphics[scale=0.4]{img/zig-a.ps}}
  \subcaptionbox{通过旋转将$X$变为根节点。}{\includegraphics[scale=0.4]{img/zig-b.ps}}
...
\bibitem{wiki-heap}
Heap (data structure), Wikipedia. \url{http://en.wikipedia.org/wiki/Heap_(data_structure)}

\bibitem{wiki-heapsort}
Heapsort, Wikipedia. \url{http://en.wikipedia.org/wiki/Heapsort}
...
Leftist Tree, Wikipedia. \url{http://en.wikipedia.org/wiki/Leftist_tree}
...
Skew heap, Wikipedia. \url{http://en.wikipedia.org/wiki/Skew_heap}

\bibitem{self-adjusting-heaps}
Sleator, Daniel Dominic; Jarjan, Robert Endre. ``Self-adjusting heaps'' SIAM Journal on Computing 15(1):52-69. doi:10.1137/0215004 ISSN 00975397 (1986)

\bibitem{wiki-splay-tree}
Splay tree, Wikipedia. \url{http://en.wikipedia.org/wiki/Splay_tree}
