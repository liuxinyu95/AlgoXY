...
Heap operations include access the top, pop, lookup the top $k$ elements, decrease an element in min-heap (or increase an element in max-heap), and insert. For binary heap, the root stores the minimum element, corresponding to the first cell in array:
