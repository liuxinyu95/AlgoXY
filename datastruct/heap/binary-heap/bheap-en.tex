...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{Step 1, 14 is the biggest element among 4, 14, and 7. Swap 4 with the left child;}{\includegraphics[scale=0.5]{img/heapify-1.ps}} \\
    \subcaptionbox{Step 2, 8 is the biggest element among 2, 4, and 8. Swap 4 with the right child;}{\includegraphics[scale=0.5]{img/heapify-2.ps}} \\
    \subcaptionbox{4 is the leaf node. It hasn't any children. Process terminates.}{\includegraphics[scale=0.5]{img/heapify-3.ps}}
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{An array in arbitrary order before heap building process;}{\includegraphics[scale=0.5]{img/build-heap-array.ps}} \\
...
\begin{figure}[htbp]
    \centering
    \subcaptionbox{The 9-th node with key 4 will be modified;}{\includegraphics[scale=0.5]{img/decrease-key-a.ps}} \\
    \subcaptionbox{The key is modified to 15, which is greater than its parent;}{\includegraphics[scale=0.5]{img/decrease-key-b.ps}} \\
    \subcaptionbox{According the max-heap property, 8 and 15 are swapped.}{\includegraphics[scale=0.5]{img/decrease-key-c.ps}}
    \caption{Example process when increase a key in a max-heap.} \label{fig:decrease-key-1}
\end{figure}

\begin{figure}[htbp]
    \centering
    \subcaptionbox{Since 15 is greater than its parent 14, they are swapped. After that, because 15 is less than 16, the process terminates.}{\includegraphics[scale=0.5]{img/decrease-key-d.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{$X$ and $P$ are both left children or both right children.}{\includegraphics[scale=0.4]{img/zig-zig-a.ps}}
  \subcaptionbox{$X$ becomes new root after rotating 2 times.}{\includegraphics[scale=0.4]{img/zig-zig-b.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{$X$ and $P$ are children on different sides.}{\includegraphics[scale=0.4]{img/zig-zag-a.ps}}
  \subcaptionbox{$X$ becomes new root. $P$ and $G$ are siblings.}{\includegraphics[scale=0.4]{img/zig-zag-b.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{$P$ is the root.}{\includegraphics[scale=0.4]{img/zig-a.ps}}
  \subcaptionbox{Rotate the tree to make $X$ be new root.}{\includegraphics[scale=0.4]{img/zig-b.ps}}
