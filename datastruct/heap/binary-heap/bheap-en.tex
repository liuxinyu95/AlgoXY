...
Below algorithm shows the iterative solution to build the min-heap
from the given index of the array.
...
Note that the \textproc{Heapify} algorithm takes $O(\lg n)$ time, where
