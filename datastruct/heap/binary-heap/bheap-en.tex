...
Where $\Phi$ means empty heap. It could be NIL in other programming environment.
This can also be described in pseudo code:
...
After that,
we need recursively
merge the other child to one of the children of the smaller one.
