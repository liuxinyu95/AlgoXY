...
By using the similar idea, we can update element at any arbitary position $i$.
...
Function $updateTree$ performs a tree search and replace the specified element
with given value.
