...
plently of areas, that more studies and works are needed to give equivallent
functional soltuion. Queue is such an important topic, that it
linkes to many fundamental purely functional data structures.
...
Note that, although we haven't mentsion priority queue, it's quite 
...
\item Realize dequeue in a symmetric soltution only with array in your
