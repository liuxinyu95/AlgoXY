...
\begin{figure}[htbp]
 \centering
 \subcaptionbox{Before \textproc{Enqueue} $x$ to queue}{\includegraphics[scale=0.7]{img/enq-list-before.ps}} \\
 \subcaptionbox{After \textproc{Enqueue} $x$ to queue}{\includegraphics[scale=0.7]{img/enq-list-after.ps}} \\
 \subcaptionbox{Before \textproc{Dequeue}}{\includegraphics[scale=0.7]{img/deq-list-before.ps}} \\
 \subcaptionbox{After \textproc{Dequeue}}{\includegraphics[scale=0.7]{img/deq-list-after.ps}} \\
...
\begin{figure}[htbp]
 \centering
 \subcaptionbox{Continuously add some elements.}{\includegraphics[scale=0.7]{img/ring-buf-1.ps}} \\
 \subcaptionbox{After remove some elements from head, there are free cells.}{\includegraphics[scale=0.7]{img/ring-buf-2.ps}} \\
 \subcaptionbox{Go on adding elements till the boundary of the array.}{\includegraphics[scale=0.7]{img/ring-buf-3.ps}} \\
 \subcaptionbox{The next element is added to the first free cell on head.}{\includegraphics[scale=0.7]{img/ring-buf-4.ps}} \\
 \subcaptionbox{All cells are occupied. The queue is full.}{\includegraphics[scale=0.7]{img/ring-buf-5.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{\textproc{DeQueue} performs poorly.}{\includegraphics[scale=0.5]{img/list-queue-head.ps}} \\
  \subcaptionbox{\textproc{EnQueue} performs poorly.}{\includegraphics[scale=0.5]{img/list-queue-tail.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{a horseshoe magnet.}{\includegraphics[scale=0.5]{img/horseshoe-magnet.eps}} \\
  \subcaptionbox{concatenate two lists tail-to-tail.}{\includegraphics[scale=0.5]{img/front-rear-queue.ps}}
...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{a horseshoe magnet.}{\includegraphics[scale=0.5]{img/horseshoe-magnet.eps}}
  \subcaptionbox{concatenate two arrays head-to-head.}{\includegraphics[scale=0.5]{img/front-rear-array-queue.ps}}
