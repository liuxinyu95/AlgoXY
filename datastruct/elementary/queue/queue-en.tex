...
\begin{figure}[htbp]
 ...
 \subfloat[Before \textproc{Dequeue}]{\includegraphics[scale=0.8]{img/deq-list-before.ps}} \\
 \subfloat[After \textproc{Dequeue}]{\includegraphics[scale=0.8]{img/deq-list-after.ps}} \\
