...
\begin{figure}[htbp]
 \centering
 \subcaptionbox{执行\textproc{Enqueue}前}{\includegraphics[scale=0.7]{img/enq-list-before}} \\
 \subcaptionbox{执行\textproc{Enqueue}后}{\includegraphics[scale=0.7]{img/enq-list-after}} \\
 \subcaptionbox{执行\textproc{Dequeue}前}{\includegraphics[scale=0.7]{img/deq-list-before}} \\
 \subcaptionbox{执行\textproc{Dequeue}后}{\includegraphics[scale=0.7]{img/deq-list-after}} \\
