...
\begin{figure}[htbp]
 \centering
 \subfloat[元素$x$在\textproc{Enqueue}前]{\includegraphics[scale=0.8]{img/enq-list-before.ps}} \\
 \subfloat[将元素$x$\textproc{Enqueue}后]{\includegraphics[scale=0.8]{img/enq-list-after.ps}} \\
 \subfloat[执行\textproc{Dequeue}前]{\includegraphics[scale=0.8]{img/deq-list-before.ps}} \\
 \subfloat[执行\textproc{Dequeue}后]{\includegraphics[scale=0.8]{img/deq-list-after.ps}} \\
