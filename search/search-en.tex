...
csearch = \left \{
  ...
  search((a, b), (p-1, q+1)) \cup \{(p, q)\} \cup search((p+1, q-1), (c, d)) & f(p, q) = z \\
  search((a, b), (p, q+1)) \cup search((p+1, q-1), (c, d)) & otherwise 
  \end{array}
\right.
\ee
...
rsearch = \left \{
  ...
  search((a, b), (p-1, q+1)) \cup \{(p, q)\} \cup search((p+1, q-1), (c, d)) & f(p, q) = z \\
  search((a, b), (p-1, q+1)) \cup search((p+1, q), (c, d)) & otherwise 
  \end{array}
\right.
\ee
...
\item TODO: add brute-force 2D binary search as exercise.
\end{itemize}
\end{Exercise}
