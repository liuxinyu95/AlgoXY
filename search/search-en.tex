...
It's worth of comparing the final pure functional and the imperative algorithms. In many cases, we
have expressive funcitonal realization, however, for KMP matching algorithm, the imperative approach
is much simple and intuitive. This is because we have to mimic the raw array by a infinite state transfer tree.
