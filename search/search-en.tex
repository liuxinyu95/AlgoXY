...
as shown in figure \ref{fig:maze-loop}. The obvious solutoin is first to go directly, then turn right,
and keep going straightforward at the 'T' section. However, if we always turn right, we'll endless
