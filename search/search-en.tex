...
\begin{figure}[htbp]
 \centering
 \subfloat[Case 1, Only a part of the matching suffix occurs as a prefix of the pattern.]{\includegraphics[scale=0.3]{img/good-suffix-case1.eps}} \\
 \subfloat[Case 2, The matching suffix occurs some where else in the pattern.]{\includegraphics[scale=0.3]{img/good-suffix-case2.eps}}
