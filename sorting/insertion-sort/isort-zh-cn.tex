...
扑克游戏中的抓牌环节非常形像地描述了插入排序的思想(\cite{CLRS}第15 - 19页)。考虑从一副洗好的牌中不断抓牌，并按序理好的过程。任何时候，人们手中的牌都是有序的。每当抓到一张新牌，就按照牌的点数，插入到合适的位置。如图\cref{fig:hand-of-cards}所示。根据这一思路，我们可以这样实现插入排序：
