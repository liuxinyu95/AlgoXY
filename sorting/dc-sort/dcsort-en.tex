...
Note that we use Zermelo Frankel expression (ZF expression for short)\footnote{Name for the two mathematicans who found the modern set theory.}, which is also known as list
