...
$f$ is in curried form, see appendix for detail. Alternatively, $f$ can be a lexical closure which is in
...
express it which saves spaces and is friendly for tail-recursive call optimization (refer to the appendix
...
can be eliminated by defining the partition function mutually recursive call the sort function. Implement this
...
Quick sort performs well in practice, however, given theoretical analysis isn't easy. It need the tool
...
Sum all them up, and eliminate same components in both sides, we can deduce to a function of $N$.
