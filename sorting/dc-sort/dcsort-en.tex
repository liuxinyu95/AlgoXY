...
In this chapter, two popular divide and conqurer sorting methods, quick sort and merge sort are introduced. 
Both of them meet the upper performance limit of the comparison based sorting algorithms $O(N \lg N)$.
Sedgewick said that quick sort is the greatest algorithm invented in the 20th centry. Almost
...
That quick sort performs perfectly in most cases, it needs fewer swapping than most other algoirthms.
...
example in embedded system with limited memory, or cause many overhead swappings by in-place workaround.
...
tree sort as explained in this chapter. Similarily, merge sort can also be deduced from tree sort
...
quite easy to divide for merge sort no matter what concreate divide method is taken: 
simple divide at the middle point, even-odd spliting, nature splitting, or bottom-up 
straight splitting. Compare to merge sort, It's more difficuilt for quick sort to
...
people are challenged by the buzz word `big data', that the traditional convinent method
can't handle more and more huge data within reasonable time and resources. 
Sorting a sequence of handreds of Gigabytes becomes a routine in some fields.
