...
there are lesson than `CutOff' elements, the sort algorithm rollback to insertion sort.
...
\item Implement the algorithm which rollback to insertion sort when the length of list is
