...
Running this program takes much more time than the quick sort. Besides the major reason we'll state later,
one problem is that this version frequentl allocate and release extra memories for merging. While memory
allocation is one of the well known bottle-neck in real word as mentioned by Bentley in \cite{pearls}.
...
TODO: Knuth method, append an equal buffer as working area, and swap between it and the original array.
