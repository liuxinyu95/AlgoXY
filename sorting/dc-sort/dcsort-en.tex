...
\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.8]{img/kids-inline}
...
\begin{figure}[htbp]
   \centering
   \subcaptionbox{Partition invariant}{\includegraphics[scale=0.5]{img/partition-1-way}} \\
   \subcaptionbox{Start}{\includegraphics[scale=0.5]{img/partition-1-way-start}} \\
   \subcaptionbox{Finish}{\includegraphics[scale=0.5]{img/partition-1-way-finish}}
...
\begin{figure}[htbp]
   \centering
   \subcaptionbox{When pointer $i$, and $j$ stop}{\includegraphics[scale=0.5]{img/partition-2-way-inner}} \\
   \subcaptionbox{Partition invariant}{\includegraphics[scale=0.5]{img/partition-2-way}} \\
...
\begin{figure}[htbp]
   \centering
   \subcaptionbox{Invariant of 3-way partition}{\includegraphics[scale=0.5]{img/partition-3-way}} \\
   \subcaptionbox{Swapping the equal parts to the middle}{\includegraphics[scale=0.5]{img/partition-3-way-end}} \\
...
\begin{figure}[htbp]
   \centering
   \includegraphics[scale=0.5]{img/partition-3-way-lumoto}
...
\begin{figure}[htbp]
   \centering
   \subcaptionbox{The partition tree for $\{x_1 < x_2 < ... < x_n\}$, There aren't any elements less than or equal to the pivot (the first element) in every partition.}{\hspace{.3\textwidth} \includegraphics[scale=0.5]{img/unbalanced} \hspace{.3\textwidth}} \\
   \subcaptionbox{The partition tree for $\{y_1 > y_2 > ... > y_n\}$, There aren't any elements greater than or equal to the pivot (the first element) in every partition.}{\includegraphics[scale=0.5]{img/unbalanced-2}} \\
...
\begin{figure}[htbp]
   \centering
   \subcaptionbox{Except for the first partition, all the others are unbalanced.}{\includegraphics[scale=0.4]{img/unbalanced-3}} \\
...
\begin{figure}[htbp]
 \centering
 \includegraphics[scale=0.8]{img/merge-in-place-naive}
