...
Figure \cref{fig:partition-1-way} gives a way to partition in-place\cite{Bentley}\cite{CLRS}. Scan from left to right. At any time, the array is consist of three parts as shown in \cref{fig:partition-1-way} (a):
