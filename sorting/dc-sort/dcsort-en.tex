...
We can define a ternery quick sort as the following.
...
The basic ternery quick sort can be implemented in Haskell as the following example code.
...
`equal-to' operations. The basic version of ternery sort concats the three sub lists by 
...
For the recusive case, as the ternery partition splits to three sub lists $S, E, G$, only $S$ and $G$
...
The tenery quick sort can also be implemented imperatively. Robert Sedgewick presented a partition
...
At any time poing during partition.

TODO: Add figures to illustrate
