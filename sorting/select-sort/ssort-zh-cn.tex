...
\begin{figure}[htbp]
  \centering
  \subcaptionbox{取出16，将其替换为$-\infty$，15上升为新的根}{\includegraphics[scale=0.6]{img/tournament-tree-2.ps}} \\
  \subcaptionbox{取出15，将其替换为$-\infty$，14上升为新的根}{\includegraphics[scale=0.6]{img/tournament-tree-3.ps}} \\
  \subcaptionbox{取出14，将其替换为$-\infty$，13上升为新的根}{\includegraphics[scale=0.6]{img/tournament-tree-4.ps}}
  \caption{锦标赛树排序的前几步}
