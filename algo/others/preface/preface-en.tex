...
It is quadratic curve which reflect the $O(n^2)$ perfromance.
...
fomula shows an interesting relationship.
...
This alogrithm loops $n$ times, and within each loop, it extract one head
